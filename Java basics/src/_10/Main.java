...
public class Main {
    ...
    private static void exercise2() {
        ...
        if (shoeType == "fancy" && age>=18 && eurosInPocket> eurosForEntry ) System.out.println("come in!");
    ...
    private static void exercise3() {
        ...
        double ourTestScore = 8.3;
        double maxTestScore = 10;
        boolean isTestRetry = false;
        //Write your code here 90* maxTextScore/100
        if (90*maxTestScore/100 < ourTestScore){
            if (!isTestRetry) System.out.println("A");
            else System.out.println("C");
        }
        else if(80*maxTestScore/100 < ourTestScore){
            if (!isTestRetry) System.out.println("B");
            else System.out.println("C");
        }
        else if(70*maxTestScore/100 <ourTestScore) System.out.println("C");
        else if(60*maxTestScore/100 <ourTestScore) System.out.println("D");
    ...
    private static void exercise4Bonus() {
        ...
        //Write your code here
        if(!carIsDrivingFromLeftToRight^carIsDrivingFromRightToLeft) System.out.println("CRASH! or No cars" );
