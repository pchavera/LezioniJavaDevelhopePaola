...
public class Main {
     ...
     * <p>
     * Then convert this back to a string and print it, it should be 90 and not 88
     */
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String ourNumberStr = "88";
        //Write your code here
        int newNumber= Integer.valueOf(ourNumberStr);
        newNumber+=2;
        ourNumberStr= String.valueOf(newNumber);
    ...
    private static void exercise2() {
        ...
        int charAtIndex = 6; // <--- CharAtIndex prende il valore char ubicato nella posizione indicata, la posizione parte dal 0
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3:");
        // compara se la variabile a convertire dentro le string sono del tipo di variabile di contenimento se non sono compatibile lancia una eccezione
        ...
        String doubleStrToConvert = "1.3"; // Also this line
    ...
    private static void exercise4() {
        ...
        startInt*=2;
        startStr=String.valueOf(startInt) + String.valueOf(startInt) ;
        Double startDbl=Math.floor(Double.valueOf(startStr)/3.5);

        System.out.println(startDbl);
